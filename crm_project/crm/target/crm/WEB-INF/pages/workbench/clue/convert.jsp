...
<script type="text/javascript">
	$(function(){
		...
		/**
		 * 给搜索框添加键盘弹起事件,clueId、activityName
		 */
		$("#keyboardUpBtn").keyup(function () {
			//
			...
			$.ajax({
				url:'workbench/clue/convertClueSelectActivity.do',
				type:'post',
				dataType:'json',
				data:{
		...
		$("#clueConvertBtn").click(function () {
			...
			var isCreateTran = $("#isCreateTransaction").val();
...
<body>
		...
		<div class="modal-dialog" role="document" style="width: 90%;">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" id="keyboardUpBtn" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
					...
					<div
				} id="title" class="page-header" style="position: relative; left: 20px;">
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form>
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
			  <label for="activityName">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="searchBarBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
	...
	<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input class="btn btn-default" id="clueCancelBtn"type="button" value="取消">
	</div>
</body>
</html>